...
function Header() {
    ...
    */
	...
	return (
		<div
			className={
				show ? `${style.header_black} ${style.header}` : style.header
			}
		>
			<img
			...
			{/* burgur */}
			<span className={style.openbtn} onClick={handleOpenNav}>
				{burger ? (
					...
					{checkLoggedIn() ? (
							...
							>
								{checkAdminLoggedIn() ? (
									<Link to='/admin'>
										<span className={style.navItem}>
											<i
												className={`fa fa-user-cog ${style.icon}`}
											></i>
											Admin
										</span>
									</Link>
									...
									<Link to='/profile'>
										<span className={style.navItem}>
											<i
												className={`fa fa-user ${style.icon}`}
											></i>
											Profile
										</span>
									</Link>
						...
						<Link to='/login'>
							<div
								...
								onClick={handlePageChange}
							>
								<span className={style.navItem}>Login</span>
							</div>
						</Link>
					)}
				</div>
