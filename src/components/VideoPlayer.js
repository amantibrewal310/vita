...
class VideoPlayer extends Component {
  ...
  handleProgress = (e) => {
    ...
    this.videoRef.current.currentTime = Math.round(
      (this.state.completeDurationInSeconds * tempProgressPercentage) / 100
    );
  };
          ...
          <div className={detailStyles.videoDetailContainer}>
            ...
            <div className={preplayStyles.bottomVideoStats}>
              ...
              <span className="vote-btn" onClick={this.handleLike}>
                <i
                  className={
                    "fa fa-thumbs-o-up" + (this.state.like ? " like" : "")
                  }
                  aria-hidden="true"
                ></i>
              ...
              {this.state.report ? (
                <span
                  ...
                  style={{ float: "right" }}
                >
                  <i className="fa fa-flag-o danger" aria-hidden="true"></i>
                  Report
                </span>
              ) : (
